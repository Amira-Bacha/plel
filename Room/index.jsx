...
class Room extends Component {
	...
	handleScreen = () => this.setState({ screen: !this.state.screen, video: !this.state.video }, () => {
		this.getDislayMedia()
    ...
    <div className='Room'>
      {this.state.askForUsername === true ?
					<div className="PreConnectionPage">
						<div style={{margin:"auto", justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted className='videoPreConnect'></video>
						</div>
						...
						<div className='InfoSpace'>
							...
							<div className="ButtonsPreConnection">
								<Fab onClick={this.handleAudio} sx={
											this.state.audio === true ? 
											{width:"40px",height:"40px",backgroundColor:"#343A40", transition:"margin-top 0.2s ease-out", border:"none", "&:hover":{
												backgroundColor:"#686D76",marginTop:"-5px"
											}}

											:

											{width:"40px",height:"40px",backgroundColor:"#BD1616", transition:"margin-top 0.2s ease-out", border:"none", "&:hover":{
												backgroundColor:"rgba(189, 22, 22, 0.75)",marginTop:"-5px"
											}}
								...
								<Fab onClick={this.handleVideo} sx={
								...
								<Fab onClick={this.handleEndCall} sx={{width:"60px", borderRadius:"50px",height:"40px",backgroundColor:"#BD1616",color:'white',transition:"margin-top 0.2s ease-out", border:"none", "&:hover":{
									backgroundColor:"rgba(189, 22, 22, 0.75)",marginTop:"-5px"
								}}} >
									<CallEndIcon  />
								</Fab>
					...
					<div className="Room">
						<div className="LeftDiv">
							...
							<div id="main" className="flex-container" style={{ margin: "10px", padding: 0 }}>
									<video id="my-video" ref={this.localVideoref} autoPlay muted className='MyVideoArea'></video>
							...
							<div className="Buttons">
								...
								<Fab onClick={this.handleScreen} sx={
										...
										this.state.screen === false ? 
											...
											{width:"40px",height:"40px",backgroundColor:"#5D8BF4", transition:"margin-top 0.2s ease-out", border:"none", "&:hover":{
												backgroundColor:"rgba(93, 139, 244, 0.75)",marginTop:"-5px"
											}}
						...
						<div className='StreamsChat'>	
							...
							<div className="MessagesBody">
								{
									...
									this.state.messages.length > 0 ? this.state.messages.map((item, index) => (
										...
										<div key={index} className="message" style={{textAlign: "right"}}>
											<p style={{fontSize:"10px", margin:"5px", fontWeight:"200"}}>{item.sender}</p>
											<p style={{ wordBreak: "break-all", margin:"5px" }}> {item.data}</p>
										</div>
							...
							<div className="MessagesFooter">
								<input variant="outlined" placeholder="Message" value={this.state.message} className="InputMessage" onChange={e => this.handleMessage(e)} />

								<IconButton aria-label="delete"  Message-btn  onClick={this.sendMessage} sx={{color:"white", cursor: "pointer"}} >
									<SendIcon  />
								</IconButton>
